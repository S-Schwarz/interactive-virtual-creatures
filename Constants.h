...
const float STANDARD_MUTATION_CHANCE = 0.5;

//evolution
const float EVOLUTION_MIN_SCORE = 0.7;
const int MAX_RESTING_STEPS = 10;
...
const float MUTATE_BODY_CONNECTION_CHANCE = 0.3;
const float MUTATE_REMOVE_BODY_CHILD_CHANCE = 0.05;
...
const float MUTATE_NEW_NEURON_CHANCE = 0.4;
const float MUTATE_REMOVE_NEURON_CHANCE = 0.05;
